...
echo "git remote add origin https://github.com/cbwinslow/cloudcurio-stackhub.git"
...
echo "# 3. Do NOT initialize with a README, .gitignore, or license"
echo "# 4. Run these commands:"
echo "git remote add gitlab https://gitlab.com/cbwinslow/cloudcurio-stackhub.git"
