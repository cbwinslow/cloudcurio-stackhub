...
# This script handles everything from SSH key generation to pushing to GitHub

echo "Complete GitHub Setup Script"
echo "=========================="
...
if [ $? -eq 0 ]; then
    ...
    echo "1. You've added the SSH key to your GitHub account"
    echo "2. The repository 'cloudcurio-stackhub' exists on GitHub"
